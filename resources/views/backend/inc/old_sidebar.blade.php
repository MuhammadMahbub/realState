    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item dropdown {{ (request()->is('property.index')) ? 'is-expanded active' : '' }}">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link dropdown-toggle {{ (request()->is('property.index')) ? 'is-expanded active' : ''}}"
                        aria-expanded="true" data-bs-toggle="dropdown">
                        <i class="fa fa-th-large" aria-hidden="true"></i>
                        <span class="hide-menu">Property Management</span>
                    </a>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ (request()->is('property_category*')) ? 'active' : '' }}" href="{{ route('property_category.index') }}">Property Category</a></li>
                        <li><a class="dropdown-item {{ (request()->is('property_type*')) ? 'active' : '' }}" href="{{ route('property_type.index') }}">Property Type</a></li>
                        <li><a class="dropdown-item {{ (request()->is('property*')) ? 'active' : '' }}" href="{{ route('property.index') }}">Property List</a></li>
                        <li><a class="dropdown-item {{ (request()->is('property_specification*')) ? 'active' : '' }}" href="{{ route('property_specification.index') }}">Property Specification</a></li>
                    </ul>
                </li>
