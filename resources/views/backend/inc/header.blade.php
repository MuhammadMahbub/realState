                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" style="">
                                        <div class="card border-0 mb-0">
                                            ...
                                            <div class="card-footer px-0 py-2">
                                                {{-- <a href="{{ route('role_shift', Auth::id()) }}" class="dropdown-item ai-icon ">
                                                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="var(--primary)" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
