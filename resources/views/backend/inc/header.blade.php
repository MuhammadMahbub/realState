...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="{{asset('backend/assets/images')}}/favicon122.png">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img src="{{asset('backend/assets/images/logo')}}/logofull-white.png" alt="LOGO">
            </a>
                                    ...
                                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="header-info2 d-flex align-items-center">
                                            <div class="header-media">
                                                @if (Auth::user()->image)
                                                <img src="{{ asset(Auth::user()->image) }}" alt="user-img" width="36" class="rounded-circle">
                                                @else
                                                <img src="{{ asset('backend/default.jpg') }}" alt="user-img" width="36" class="rounded-circle">
                                                @endif
                                                {{-- <img src="{{asset('backend/assets/images')}}/tab/1.jpg" alt=""> --}}
                                            </div>
                                        ...
                                        <div class="card border-0 mb-0">
                                            <div class="card-header py-2">
                                                <div class="products">
                                                    ...
                                                    <img src="{{ asset('backend/default.jpg') }}" alt="user-img" width="36" class="rounded-circle">
                                                    @endif
                                                    {{-- <img src="{{asset('backend/assets/images')}}/tab/1.jpg" class="avatar avatar-md" alt=""> --}}
                                                    <div>
                                                        <h6>{{ Auth::user()->name ?? '' }}</h6>
                                                        <p>{{ Auth::user()->email ?? '' }}</p>
                                                    </div>	
