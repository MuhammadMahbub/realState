        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li class="{{ request()->routeIs(['news.index','news.show']) ? 'mm-active' : '' }}"><a class="{{ request()->routeIs(['news.index','news.show','news_show']) ? 'mm-active' : '' }}" href="{{ route('news.index') }}">News/Blogs</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <span class="nav-text">Preferred Choice</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('preferred_choices.index') }}">Preferred Choice</a></li> 
                </ul>
            </li>
            ...
            {{--  Messages  --}}
            <li><a href="{{ route('message.index') }}" class="" aria-expanded="false">
                <div class="menu-icon">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="0.5" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                </div>	
