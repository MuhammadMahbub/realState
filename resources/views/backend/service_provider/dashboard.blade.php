...
@section('title', "Dashbord - BPS SERVICE PROVIDER DASHBOARD")
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>None-Active Service Provider</h6>
                        <h3>0</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>Verified Service Provider</h6>
                        <h3>0</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>Commission From Service Provider</h6>
                        <h3>0</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>Subscription From Service Provider</h6>
                        <h3>0</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>Total Services Listed By Service Provider</h6>
                        <h3>0</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card chart-grd same-card">
            <div class="card-body depostit-card p-0">
                <div class="depostit-card-media d-flex justify-content-between pb-0">
                    <div>
                        <h6>Total Revenue From Service Provider</h6>
                        <h3>$54,245,741.00</h3>
                    </div>
                    <div class="icon-box bg-danger-light">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="col-lg-12">
    <div class="card overflow-hidden">
        <div class="card-header border-0 pb-0 flex-wrap">
            <h4 class="heading mb-0">Service Provider Analytics</h4>
        ...
        <br/>
        <ul class="inline">
        <li><i class="fa fa-circle" style="color: red;"></i> Active Service Provider</li>
        <li><i class="fa fa-circle" style="color: green;"></i> Total Service Provider</li>                                
        </ul>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <div class="tbl-caption">
                    <h4 class="heading mb-0">Service Provider List</h4>
                    <div>
                        <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">+ Add Service Provider</a>
...
@push('modals')
        ...
        <div class="offcanvas offcanvas-end customeoff" tabindex="-1" id="offcanvasExample">
                  ...
                  <form>
                      <div class="row">
                          <div class="col-xl-6 mb-3">
                              <label for="exampleFormControlInput2" class="form-label">Service Provider Name<span class="text-danger">*</span></label>
                              <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Enter Service Provider Name">
                          </div>	
                          <div class="col-xl-6 mb-3">
                              <label for="exampleFormControlInput3" class="form-label">Service Provider Email<span class="text-danger">*</span></label>
                              <input type="email" class="form-control" id="exampleFormControlInput3" placeholder="Enter Service Provider Name">
                          </div>
                          <div class="col-xl-6 mb-3">
                              <label for="exampleFormControlInput4" class="form-label">Password<span class="text-danger">*</span></label>
                              <input type="password" class="form-control" id="exampleFormControlInput4" placeholder="Enter Service Provider Password">
                          </div>
                          <div class="col-xl-6 mb-3">
          ...
          <!-- Add Service Providers End -->
  
          <!-- Invite New Service Providers -->
          <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-center">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel1">Invite Service Provider</h1>
          ...
          <!-- Invite New Service Provider End -->
    @endpush
