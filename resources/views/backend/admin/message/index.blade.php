...
<div class="page-titles">
    <ol class="breadcrumb">
        <li><h5 class="bc-title">All Messages</h5></li>
    </ol>
            ...
            <div class="table-responsive active-projects style-1">
                ...
                <table id="empoloyees-tblwrapper" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $loop->index + 1}}</td>
                            <td>{{ $message->messageProperty->short_title }}</td>
                            <td>{{ $message->name ?? ''}}</td>
                            <td>{{ $message->email ?? ''}}</td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteMessage{{ $message->id }}">Delete</a></li>
                                    </ul>
                                  </div>
                            </td>
                        </tr>
                        ...
                        <!-- Users Delete Modal -->
                        @push('modals')
                        <div class="modal fade" id="deleteMessage{{ $message->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
